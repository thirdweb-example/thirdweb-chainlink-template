...
import "../../contracts/RandomNumberConsumerV2.sol";
...
contract VRFConsumerV2Test is Test {
    ...
    RandomNumberConsumerV2 public vrfConsumer;
    ...
    function setUp() public {
        ...
        vrfConsumer = new RandomNumberConsumerV2(
            subId,
    ...
    {
        uint256[] memory words = new uint256[](vrfConsumer.NUM_WORDS());
        for (uint256 i = 0; i < vrfConsumer.NUM_WORDS(); i++) {
